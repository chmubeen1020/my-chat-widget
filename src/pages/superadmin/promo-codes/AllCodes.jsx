            ...
            <tr key={promo.id} className="hover:bg-slate-50/50 transition-colors">
              ...
              <td className="px-6 py-4">
                <div className="flex justify-center gap-3 text-slate-400">
                  <button onClick={() => setModal({ type: "view", data: promo })} className="hover:text-indigo-600 transition-colors p-1"><BarChart2 size={18} /></button>
                  <button onClick={() => setModal({ type: "edit", data: promo })} className="hover:text-indigo-600 transition-colors p-1"><Edit3 size={18} /></button>
              ...
              {modal.type === "view" && (
                <div className="p-6">
                  ...
                  <div className="flex justify-end mt-8">
                    <button onClick={closeModal} className="px-6 py-2 bg-slate-900 text-white rounded-xl text-sm font-medium">Close</button>
                  </div>
                </div>
              )}
